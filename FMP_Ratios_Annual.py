...
limit = '25'                   # MAX NUMBER OF PERIODS TO RETURN: MAX = 140
data_directory = "Data/"        # DIRECTORY NAME UNDER THIS SCRIPTS LOCATION
output_file_directory ="Stock-Fundamentals/Annual/"  # DIRECTORY NAME TO STORE OUTPUT CSV FILES
...
for x in stock_list['Symbol']:
  ...
  filename = x + '-Company-Ratios-Annual.csv'       # DEFINE THE FILENAME FOR CSV OUTPUT
